resource "vault_aws_secret_backend" "aws" {
  ...
  access_key = data.terraform_remote_state.vault_admin.outputs.vault-admin_accesskey
  secret_key = data.terraform_remote_state.vault_admin.outputs.vault-admin_secret_accesskey
...
#       "Effect": "Allow",
#       "Action": "iam:GetUser",
#       "Resource": "arn:aws:iam::443370677730:user/vault-token-terraform-*"
#     }
#   ]
# }
# EOT
