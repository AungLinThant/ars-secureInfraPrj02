resource "vault_aws_secret_backend" "aws" {
  ...
  access_key = data.terraform_remote_state.vault-admin.outputs.vault-admin_accesskey
  secret_key = data.terraform_remote_state.vault-admin.outputs.vault-admin_secret_accesskey
